...
const SECONDS_BEFORE_RESTART: number = parseInt(process.env.SECONDS_BEFORE_RESTART_ON_ERROR || '1200' /* default 20 minutes */)
...
export { DEBUG, DEBUG_BROWSER, SECONDS_BETWEEN_CHECKS, SECONDS_BEFORE_RESTART, SECONDS_TIMEOUT, KOS_USERNAME, KOS_PASSWORD};